"""Delta audio embedding stage: S3 raw wav -> Wav2Vec2 embedding -> S3 + Pinecone."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Embed audio deltas from S3 and upsert to Pinecone")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="audio_embed_") as tmp_dir:
            ...
            for item in delta:
                ...
                vector_id = f"audio:{item.video_id}"
