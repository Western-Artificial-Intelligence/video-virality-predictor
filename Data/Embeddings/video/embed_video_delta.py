"""Delta video embedding stage: S3 raw mp4 -> VideoMAE embedding -> S3 + Pinecone."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Embed video deltas from S3 and upsert to Pinecone")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="video_embed_") as tmp_dir:
            ...
            for item in delta:
                ...
                vector_id = f"video:{item.video_id}"
