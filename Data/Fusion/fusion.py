...
VIDEO_EMB_PATH = "../Embeddings/videomae_embeddings.npy"
AUDIO_EMB_PATH = "../Audio/audio_embeddings.npy"
TEXT_EMB_PATH  = "../Embeddings/Text_Embeddings/text_embeddings_with_ids.npy"
